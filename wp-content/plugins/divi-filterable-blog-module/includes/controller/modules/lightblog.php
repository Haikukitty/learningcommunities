...
/**
 * Divi - Filterable Blog Module - Controller Modules Blog Light
 *
 * @since	1.0.0
 */
if ( ! class_exists( 'dfbmControllerModulesLightblog' ) )
{

	class dfbmControllerModulesLightblog extends ET_Builder_Module
	{
		...
		public function init()
		{
			 ...
			 * @since 1.0.0
			 */
			$this->name = esc_html__( DFBM()->light(), DFBM()->domain() );

			$this->slug = 'et_pb_dfbm_blog_light';
			...
			$this->custom_css_options = [
				...
				'feat_blogs_post_content' =>
				[

					'label'    => esc_html__( 'Featured Posts - Post Content', DFBM()->domain() ),
					'selector' => "
						{$this->main_css_element} .et_pb_bg_layout_light .et_pb_featured_posts .post-content,
						{$this->main_css_element} .et_pb_bg_layout_dark .et_pb_featured_posts .post-content",

				],
				'feat_blogs_post_body' =>
				[

					'label'    => esc_html__( 'Featured Posts - Post Body', DFBM()->domain() ),
					'selector' => "
						{$this->main_css_element} .et_pb_bg_layout_light,
						{$this->main_css_element} .et_pb_bg_layout_dark,
						{$this->main_css_element} .et_pb_bg_layout_light .et_pb_featured_posts .post-content *,
						{$this->main_css_element} .et_pb_bg_layout_dark .et_pb_featured_posts .post-content *",
				...
				[
					...
					'label'    => esc_html__( 'Filterable Posts - Post Content', DFBM()->domain() ),
					'selector' => "
				...
				[
					...
					'label'    => esc_html__( 'Featured Posts - Post Body', DFBM()->domain() ),
					'selector' => "
						{$this->main_css_element} .et_pb_bg_layout_light .filterable-blogposts,
						{$this->main_css_element} .et_pb_bg_layout_dark .filterable-blogposts,
						{$this->main_css_element} .et_pb_bg_layout_light ..filterable-blogposts .post-content *,
						{$this->main_css_element} .et_pb_bg_layout_dark ..filterable-blogposts .post-content *",
				...
				[
					...
					'label'    => esc_html__( 'Pagination Text', DFBM()->domain() ),
					'selector' => "
				...
				[
					...
					'label'    => esc_html__( 'Pagination Text Current', DFBM()->domain() ),
					'selector' => "{$this->main_css_element} .dfbm_blog_pagination .current",
				...
				[
					...
					'label'    => esc_html__( 'WooCommerce Price Text', DFBM()->domain() ),
					'selector' => "
				...
				[
					...
					'label'    => esc_html__( 'WooCommerce Onsale Text', DFBM()->domain() ),
					'selector' => "
				...
				[
					...
					'label'    => esc_html__( 'WooCommerce Price Text - Filterable Blogs', DFBM()->domain() ),
					'selector' => "
				...
				[
					...
					'label'    => esc_html__( 'WooCommerce Onsale Text - Filterable Blogs', DFBM()->domain() ),
					'selector' => "
