<?php
/**
 * Register options settings for the theme.
 *
 * @package     Ethority
    ...
    */
    'settings'        => array(
      ...
      */
      ...
      array(
        'id'          => 'eth_blog_page_title',
        'label'       => __( 'Blog Page Title', 'eth-theme' ),
        'desc'        => __( 'Heading text of the blog page', 'eth-theme' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'general',
        'operator'    => 'and'
      ...
      array(
        'id'          => 'eth_lp_layout',
        'label'       => __( 'Landing Page Sections', 'eth-theme' ),
        'desc'        => '',
        'std'         => '',
        'type'        => 'list-item',
        'section'     => 'general',
        ...
        'settings'    => array(
          array(
            'id'          => 'eth_lp_section',
            'label'       => __( 'Section', 'eth-theme' ),
            'desc'        => __( 'Select a section', 'eth-theme'),
            'std'         => '',
            'type'        => 'select',
            'operator'    => 'and',
            'choices'     => array(
              array(
              'value'       => 'section-home',
              'label'       => __( 'Home Section', 'eth-theme' )
              ),
              array(
              'value'       => 'section-reviews',
              'label'       => __( 'Reviews Section', 'eth-theme' )
              ),
              array(
              'value'       => 'section-features',
              'label'       => __( 'Features Section', 'eth-theme' )
              ),
              array(
              'value'       => 'section-overview',
              'label'       => __( 'Overview Section', 'eth-theme' )
              ),
              array(
              'value'       => 'section-cta',
              'label'       => __( 'Call to Action Section', 'eth-theme' )
              ),
              array(
              'value'       => 'section-testimonials',
              'label'       => __( 'Testimonials Section', 'eth-theme' )
              ),
              array(
              'value'       => 'section-purchase',
              'label'       => __( 'Purchase Section', 'eth-theme' )
              ),
              array(
              'value'       => 'section-author',
              'label'       => __( 'Author Section', 'eth-theme' )
              ),
              array(
              'value'       => 'section-subscribe',
              'label'       => __( 'Subscribe Section', 'eth-theme' )
              ),
              array(
              'value'       => 'section-contact',
              'label'       => __( 'Contact Section', 'eth-theme' )
              ),
              array(
              'value'       => 'section-footer',
              'label'       => __( 'Footer Section', 'eth-theme' )
              )
            )
          ),
        )
      ...
      */
      array(
        'id'          => 'eth_header',
        'label'       => __( 'Header Section', 'eth-theme' ),
        'desc'        => __( 'This is the settings used for the header section where the logo and menu is located.', 'eth-theme' ),
        'std'         => '',
      ...
      array(
        'id'          => 'eth_header_bg_color',
        'label'       => __( 'Background Color', 'eth-theme' ),
        'desc'        => __( 'Choose the background color of this section.', 'eth-theme' ),
        'std'         => '',
        'type'        => 'colorpicker',
        'section'     => 'header',
        'operator'    => 'and'
      ...
      array(
        'id'          => 'eth_logo_height',
        'label'       => __( 'Height of Logo Image (in px)', 'eth-theme' ),
        'desc'        => __( 'Only use this setting if your logo does not fit the current menu height.', 'eth-theme' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'header',
        'operator'    => 'and'
      ...
      array(
        'id'          => 'eth_menu_height',
        'label'       => __( 'Height of menu (in px)', 'eth-theme' ),
        'desc'        => __( 'Adjust menu height. Leave blank for default size.', 'eth-theme' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'header',
        'operator'    => 'and'
      ...
      */
      ...
      array(
        'id'          => 'eth_testimonials_bg_color_odd',
        'label'       => '',
        'desc'        => __( 'Choose the background color for odd numbered testimonials.', 'eth-theme' ),
        'std'         => '',
        'type'        => 'colorpicker',
        'section'     => 'testimonials',
        'operator'    => 'and'
      ...
      array(
        'id'          => 'eth_testimonials_bg_color_even',
        'label'       => '',
        'desc'        => __( 'Choose the background color for even numbered testimonials.', 'eth-theme' ),
        'std'         => '',
        'type'        => 'colorpicker',
        'section'     => 'testimonials',
        'operator'    => 'and'
      ...
      */
      array(
        'id'          => 'eth_subscribe',
        'label'       => __( 'Subscribe Section (Using Mailchimp)', 'eth-theme' ),
        'desc'        => sprintf( __( 'This is the settings used for the landing page template. You will need to use <a href="%s" %s>Mailchimp for WordPress plugin</a> to use this section.', 'eth-theme' ), esc_url( 'https://wordpress.org/plugins/mailchimp-for-wp/' ), 'target="_blank"' ),
        'std'         => '',
        'type'        => 'textblock-titled',
        'section'     => 'subscribe',
        'operator'    => 'and'
      ...
      array(
        'id'          => 'eth_subscribe_title_highlight',
        'label'       => '',
        'desc'        => __( 'Text to highlight.', 'eth-theme' ),
        'std'         => '',
        'type'        => 'text',
      ...
      array(
        'id'          => 'eth_subscribe_mc4wp_shortcode',
        'label'       => __( 'Mailchimp Shortcode', 'eth-theme' ),
        'desc'        => __( 'Enter the mailchimp form shortcode. It should be [mc4wp_form] by default.', 'eth-theme' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'subscribe',
        'operator'    => 'and'
